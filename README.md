...
| 서비스 | URL |
|---|---|
| Web (Next.js) | https://ai-ad-platform-web-663513237336.asia-northeast3.run.app |
| API (FastAPI, `/docs`) | https://ai-ad-platform-api-663513237336.asia-northeast3.run.app |

로그인: `admin@nolbal.com` / `ChangeMe!234` · 실 Gemini 연동. (데모는 SQLite in-memory,
인스턴스 재기동 시 시드 초기화. 프로덕션은 Cloud SQL/Postgres 권장.)
